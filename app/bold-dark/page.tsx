...
import { ArrowRight, Zap, Home, Clock, TrendingDown, BookOpen, Target, Rocket, TrendingUp, ChevronDown, ChevronLeft, ChevronRight } from "lucide-react"
            ...
            <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
                <div className="mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c4ff00]/20 border border-[#c4ff00] mb-8">
                        <span className="text-sm font-bold uppercase tracking-wider text-[#c4ff00]">Proof</span>
                    </div>
                    <h2 className="font-bold text-5xl lg:text-7xl leading-tight tracking-tight max-w-4xl mb-12">
                        REAL RESULTS
                        <br />
                        <span className="text-[#c4ff00]">REAL CLIENTS</span>
                    </h2>
                </div>
                ...
                <div className="relative">
                        ...
                        <div className="flex">
                            {testimonials.map((testimonial, index) => (
                                <div key={index} className="flex-[0_0_100%] min-w-0 px-4">
                                    <div className="bg-white/5 border-2 border-[#c4ff00] p-8 hover:bg-white/10 transition-colors">
                                        <div className="flex flex-col md:flex-row gap-8 items-start">
                                            {/* Number Square - Top on mobile, Left on desktop */}
                                            <div className="flex-shrink-0 w-full md:w-48 h-48 bg-white/5 overflow-hidden flex items-center justify-center group-hover:bg-[#c4ff00]/20 transition-colors duration-300">
                                                <span className="text-[#c4ff00] text-6xl font-bold">{testimonial.number}</span>
                                            </div>
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <h3 className="font-bold text-lg mb-1 text-[#c4ff00]">{testimonial.name}</h3>
                                                ...
                                                <div className="flex items-center gap-4 text-xs">
                                                    <div className="text-gray-400">
                                                        <div className="uppercase tracking-wider mb-2 text-gray-500">Before</div>
                                                    ...
                                                    <div className="font-bold">
                                                        <div className="uppercase tracking-wider mb-2 text-gray-500">After</div>
                    ...
                    {/* Navigation Arrows */}
                    <button
                        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white/10 border-2 border-[#c4ff00] p-3 hover:bg-[#c4ff00] hover:text-black transition-colors"
                        onClick={scrollPrev}
                    ...
                    <button
                        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white/10 border-2 border-[#c4ff00] p-3 hover:bg-[#c4ff00] hover:text-black transition-colors"
                        onClick={scrollNext}
                ...
                <div className="flex justify-center gap-2 mt-8">
                    {scrollSnaps.map((_, index) => (
                        <button
                            key={index}
                            className={`w-3 h-3 border-2 border-[#c4ff00] transition-colors ${
                                index === selectedIndex ? "bg-[#c4ff00]" : "bg-transparent"
                            }`}
...
export default function BoldDark() {
    return (
        <div className="min-h-screen bg-black text-white">
                ...
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8 relative">
                    <div className="max-w-5xl">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c4ff00]/20 border border-[#c4ff00] mb-8">
                            ...
                            <span className="text-sm font-bold uppercase tracking-wider text-[#c4ff00]">Limited Spots Available</span>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-8 max-w-2xl">
                            ...
                            <div className="border-l-4 border-[#c4ff00] pl-4">
                                <div className="font-bold text-4xl lg:text-5xl text-[#c4ff00] tracking-tight">70X</div>
            ...
            {/* Social Proof Strip */}
            <section className="py-12 bg-[#c4ff00] text-black">
            ...
            <section className="py-20 lg:py-32 bg-white/5">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
                    <div className="mb-16">
                        ...
                        <h2 className="font-bold text-5xl lg:text-7xl leading-tight tracking-tight max-w-4xl">
                            WHY BUSINESS OWNERS
                            <br />
                            <span className="text-gray-500">STRUGGLE WITH SOCIAL MEDIA</span>
                        </h2>
                    </div>

                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-black border-2 border-white/20 p-8 hover:border-[#c4ff00] transition-colors">
                            <Clock className="w-12 h-12 mb-6 text-[#c4ff00]" />
                            <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">Time Drain</h3>
                        ...
                        <div className="bg-black border-2 border-white/20 p-8 hover:border-[#c4ff00] transition-colors">
                            <TrendingDown className="w-12 h-12 mb-6 text-[#c4ff00]" />
                            <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">No Strategy</h3>
                            <p className="text-gray-400 leading-relaxed">
                        ...
                        <div className="bg-black border-2 border-white/20 p-8 hover:border-[#c4ff00] transition-colors">
                            <BookOpen className="w-12 h-12 mb-6 text-[#c4ff00]" />
                            <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">Steep Learning Curve</h3>
                            <p className="text-gray-400 leading-relaxed">
            ...
            <section className="py-20 lg:py-32 bg-black">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
                    <div className="mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c4ff00]/20 border border-[#c4ff00] mb-8">
                            <span className="text-sm font-bold uppercase tracking-wider text-[#c4ff00]">The Solution</span>
                        </div>
                        <h2 className="font-bold text-5xl lg:text-7xl leading-tight tracking-tight max-w-4xl">
                            WHY BUSINESS OWNERS
                            <br />
                            <span className="text-[#c4ff00]">CHOOSE US</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-16">
                        <div className="bg-white/5 border-2 border-white/20 p-8">
                            ...
                            <div className="font-bold text-lg pt-4 border-t-2 border-white/20 text-gray-300">
                                Result: Burned out with 100 views per post
                            </div>
                        </div>

                        <div className="bg-[#c4ff00] text-black border-4 border-[#c4ff00] p-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white/5 border-2 border-[#c4ff00] p-8 hover:bg-white/10 transition-colors">
                            <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">100X Your Reach in 6 Months</h3>
                            <p className="text-gray-400 leading-relaxed">
                        ...
                        <div className="bg-white/5 border-2 border-[#c4ff00] p-8 hover:bg-white/10 transition-colors">
                            <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">Turn Followers Into Paying Customers</h3>
                            <p className="text-gray-400 leading-relaxed">
                        ...
                        <div className="bg-white/5 border-2 border-[#c4ff00] p-8 hover:bg-white/10 transition-colors">
                            <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">Professional Quality Without the Learning Curve</h3>
                            <p className="text-gray-400 leading-relaxed">
                        ...
                        <div className="bg-white/5 border-2 border-[#c4ff00] p-8 hover:bg-white/10 transition-colors">
                            <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">Consistent Growth That Compounds</h3>
                            <p className="text-gray-400 leading-relaxed">
            ...
            <section className="py-20 lg:py-32 bg-white/5">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
                    <div className="mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c4ff00]/20 border border-[#c4ff00] mb-8">
                            <span className="text-sm font-bold uppercase tracking-wider text-[#c4ff00]">The Opportunity</span>
                        </div>
                        <h2 className="font-bold text-5xl lg:text-7xl leading-tight tracking-tight max-w-4xl mb-12">
                            WHY BUILD YOUR
                            <br />
                            <span className="text-[#c4ff00]">PERSONAL BRAND?</span>
                        </h2>
                    </div>

                    <div className="grid lg:grid-cols-2 gap-12">
                        <div>
                            <h3 className="font-bold text-3xl mb-6 tracking-tight text-[#c4ff00]">WHAT DO THEY HAVE IN COMMON?</h3>
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={index} className="border-l-4 border-[#c4ff00] pl-6 py-2 bg-black">
                                        <div className="font-bold text-xl">{person.name}</div>
                                        <div className="text-gray-400">{person.business}</div>
                                        <div className="text-[#c4ff00] font-bold text-lg">{person.achievement}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            <div className="bg-[#c4ff00]/10 border-2 border-[#c4ff00] p-8">
                                <p className="text-xl leading-relaxed mb-6 text-gray-300">
                                    ...
                                    started businesses, their companies <span className="font-bold text-[#c4ff00]">EXPLODED</span>.
                                </p>
                            ...
                            <div className="bg-black border-2 border-white/20 p-8">
                                <h4 className="font-bold text-2xl mb-6 tracking-tight text-[#c4ff00]">THE NUMBERS DON'T LIE</h4>
                                <div className="space-y-4">
                                    <div className="flex items-start gap-4">
                                        <div className="font-bold text-4xl text-[#c4ff00]">4.26B</div>
                                        <div className="text-gray-400 pt-2">Social media users worldwide</div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <div className="font-bold text-4xl text-[#c4ff00]">54%</div>
                                        <div className="text-gray-400 pt-2">Use social media to research products</div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        <div className="font-bold text-4xl text-[#c4ff00]">71%</div>
                                        <div className="text-gray-400 pt-2">Purchase decisions made on social media</div>
                                    </div>
                                </div>
                            </div>

                            <div className="bg-[#c4ff00] text-black p-8 border-2 border-[#c4ff00]">
            ...
            <section id="how-it-works" className="py-20 lg:py-32 bg-black">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
                    <div className="mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c4ff00]/20 border border-[#c4ff00] mb-8">
                            <span className="text-sm font-bold uppercase tracking-wider text-[#c4ff00]">How It Works</span>
                        </div>
                        <h2 className="font-bold text-5xl lg:text-7xl leading-tight tracking-tight max-w-3xl">
                            4 STEPS TO
                            <br />
                            <span className="text-[#c4ff00]">VIRAL CONTENT</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {[
                            ...
                            <div
                                key={index}
                                className="bg-white/5 border-2 border-[#c4ff00] hover:bg-white/10 transition-colors p-8 lg:p-10 group"
                            >
                                <div className="flex items-start justify-between mb-6">
                                    <div className="w-14 h-14 bg-[#c4ff00] flex items-center justify-center">
                                        <item.icon className="w-8 h-8 text-black" />
                                    </div>
                                    <span className="font-bold text-6xl text-white/10 group-hover:text-[#c4ff00]/40 transition-colors">
                                        {item.number}
                                    </span>
                                </div>
                                <h3 className="font-bold text-2xl mb-4 tracking-tight text-[#c4ff00]">{item.title}</h3>
            ...
            <section id="pricing" className="py-20 lg:py-32 bg-black">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
                    <div className="mb-16 text-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c4ff00]/20 border border-[#c4ff00] mb-8">
                            <span className="text-sm font-bold uppercase tracking-wider text-[#c4ff00]">Pricing</span>
                        </div>
                        <h2 className="font-bold text-5xl lg:text-7xl leading-tight tracking-tight">
                            CHOOSE YOUR
                            <br />
                            <span className="text-[#c4ff00]">GROWTH PLAN</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                        ...
                        <div className="bg-white/5 border-2 border-white/20 p-8">
                            ...
                            <Button className="w-full bg-[#c4ff00] text-black hover:bg-[#c4ff00]/90 font-bold uppercase tracking-wider h-12">
                                BOOK A CALL
                            </Button>
                        </div>

                        {/* SCALE Plan */}
                        <div className="bg-[#c4ff00] text-black border-4 border-[#c4ff00] p-8 relative transform lg:scale-105">
                            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-black text-[#c4ff00] px-6 py-2 text-sm uppercase tracking-wider font-bold border-2 border-[#c4ff00]">
                                Most Popular
                            </div>
                            ...
                            <Button className="w-full bg-black text-[#c4ff00] hover:bg-gray-900 font-bold uppercase tracking-wider h-12 border-2 border-black">
                                BOOK A CALL
                            </Button>
                        </div>
                        ...
                        {/* DOMINATE Plan */}
                        <div className="bg-white/5 border-2 border-white/20 p-8">
                            <h3 className="font-bold text-4xl mb-4 tracking-tight text-[#c4ff00]">DOMINATE</h3>
                            <div className="mb-8">
            ...
            <section className="py-20 lg:py-32 bg-white/5">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
                    <div className="mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c4ff00]/20 border border-[#c4ff00] mb-8">
                            <span className="text-sm font-bold uppercase tracking-wider text-[#c4ff00]">Questions</span>
                        </div>
                        <h2 className="font-bold text-5xl lg:text-7xl leading-tight tracking-tight max-w-3xl">
                            FREQUENTLY ASKED
                            <br />
                            <span className="text-[#c4ff00]">QUESTIONS</span>
                        </h2>
                    </div>
                    ...
                    <div className="max-w-4xl space-y-6">
                        {[
                            ...
                            <details
                                key={index}
                                className="bg-black border-2 border-[#c4ff00] hover:bg-white/5 transition-colors group"
                            >
                                <summary className="p-6 lg:p-8 cursor-pointer flex items-center justify-between">
                                    ...
                                    <ChevronDown className="w-6 h-6 text-[#c4ff00] transition-transform group-open:rotate-180 flex-shrink-0" />
                                </summary>
            ...
            {/* Final CTA Section */}
            <section className="py-20 lg:py-32 bg-[#c4ff00] text-black">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8 text-center">
                    <h2 className="font-bold text-5xl lg:text-7xl tracking-tight mb-8">READY TO GO VIRAL?</h2>
                    <p className="text-xl lg:text-2xl mb-12">
                        Book a free call. We'll show you exactly how we'll grow your account.
                    </p>
                    <Button
                        size="lg"
                        className="bg-black text-[#c4ff00] hover:bg-gray-900 text-lg font-bold uppercase tracking-wider h-16 px-12 border-2 border-black"
                    >
                        Book Your Free Call
                        <ArrowRight className="w-6 h-6 ml-2" />
                    </Button>
            ...
            <footer className="py-12 border-t border-[#c4ff00]/20">
                <div className="max-w-[1140px] mx-auto px-4 lg:px-8">
